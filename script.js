    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Anime aam uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0407ef90-8875-4405-8054-8b5c8693fd37',
                    name: data.name || '',
                    email: data.email || '',
